...
$('#button-register').live('click', function() {
	$.ajax({
		...
		type: 'post',
		data: $('#payment-address input[type=\'text\'], #payment-address input[type=\'password\'], #payment-address input[type=\'checkbox\']:checked, #payment-address input[type=\'radio\']:checked, #payment-address input[type=\'hidden\'], #payment-address select, #payment-address input[type=\'email\'],  #payment-address input[type=\'tel\']'),
		dataType: 'json',
		beforeSend: function() {
...
$('#button-shipping-address').live('click', function() {
	$.ajax({
		...
		type: 'post',
		data: $('#shipping-address input[type=\'text\'], #shipping-address input[type=\'password\'], #shipping-address input[type=\'checkbox\']:checked, #shipping-address input[type=\'radio\']:checked, #shipping-address select, #shipping-address input[type=\'email\'],  #shipping-address input[type=\'tel\']'),
		dataType: 'json',
		beforeSend: function() {
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['company']) {
					$('#shipping-address input[name=\'company\']').after('<span class="error">' + json['error']['company'] + '</span>');
				}		
