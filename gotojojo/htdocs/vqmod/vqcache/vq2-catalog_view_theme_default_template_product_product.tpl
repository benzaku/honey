    ...
    <div class="right">
      <div class="description">
        ...
        <span><?php echo $text_stock; ?></span> 
				<?php echo $stock; ?><?php if ($weight) { ?>
				<br /><span><?php echo $text_weight; ?></span> <?php echo $weight; ?><?php } ?></div>
      <?php if ($price) { ?>
<?php if ($price != $display_retail_price) { ?>
      <span class="price"><?php echo $text_retail_price; ?></span><span class="price-old" style="font-size: 20px"><?php echo $display_retail_price; ?></span><span class="price"><?php echo $text_your_cost; ?></span>
      <?php }else{?>
